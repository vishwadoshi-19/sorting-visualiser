...
export default function Home() {
  ...
  return (
    <main className="absolute top-0 h-screen w-screen z-[-2] bg-[#000000]  bg-[size:40px_40px]">
        ...
        >
          <div className="h-[66px] relative flex items-center justify-between w-full">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              >
                {requiresReset ? (
                  <RxReset className="text-black-400 h-8 w-8" />
                ) : (
                  <FaPlayCircle className="text-system-purple10 h-8 w-8" />
                )}
              </button>
            </div>
